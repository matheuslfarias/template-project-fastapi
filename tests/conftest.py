...
# WARNING: Ensure imports from `template_project_fastapi` comes after this line
from template_project_fastapi import app, settings, db  # noqa
from template_project_fastapi.cli import create_user, cli  # noqa
